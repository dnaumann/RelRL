/*
https://github.com/rcdickerson/rhle-benchmarks/blob/main/gni/denning2.imp
*/
  ...
  modifies f1_l_1, f1_l_2, f2_l_1, f2_l_2, f4_h_1, f4_h_2;
{
  ...
  f2_l_1 := n1 + sum1 + integer_divide(sum1, n1); 
  f2_l_2 := n2 + sum2 + integer_divide(sum2, n2);
  f1_l_1 := f2_l_1; f1_l_2 := f2_l_2;
