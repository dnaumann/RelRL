...
Axiom H8 : (r_flipcoin_ret = 0%Z).

Parameter r_s2: state.

Axiom H9 : ((alloct r_s2) = (alloct r_s1)).

Axiom H10 : ((high r_s2) = (high r_s1)).

Axiom Ensures2 : ((low r_s2) = (1%Z - (low r_s1))%Z).

Axiom Ensures3 : okRefperm l_s1 r_s2 pi.

(* Why3 goal *)
Theorem prog'vc : ((low l_s1) = (low r_s2)).
Proof.
