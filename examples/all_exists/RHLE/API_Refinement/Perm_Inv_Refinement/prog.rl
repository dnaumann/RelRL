...
bimodule FREL (A | B) =
  ...
  predicate is_permutation3_bipred (l: intList | l: intList) =
    let fst | fst = listNth(0, l) | listNth(0, l) in
    let snd | snd = listNth(1, l) | listNth(1, l) in
    let third | third = listNth(2, l) | listNth(2, l) in
 ...
 =
    ...
    (havoc refinedGetValues_ret| skip);
    ...
    HavocR originalGetValues_ret { [> equals3(originalGetValues_ret, choice_list) |> };
